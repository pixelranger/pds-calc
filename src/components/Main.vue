          ...
          <div class="">
            ...
            <template v-if="isCalculated">
              ...
              <div class="mt-10 text-left text-sm text-gray-500 mb-5">
                Не является офертой и не гарантирует доходность в будущем. Ожидаемая доходность в размере 10% годовых.
                Расчеты
                ...
                Расчет налогового вычета произведен с учетом изменений в Налоговом кодексе, которые вступили в силу в
                2024 году
              </div>
            </template>
          </div>
